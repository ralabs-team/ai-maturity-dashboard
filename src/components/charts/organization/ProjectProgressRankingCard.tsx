...
export default function ProjectProgressRankingCard({
  rows,
  waveLabel,
}: {
  rows: Row[];
  ...
  return (
    <section className="rounded-2xl border border-[#eaeaea] bg-white p-6 shadow-sm">
      ...
      <p className="mt-1 text-sm text-[#7a7a7a]">
        Rank projects or teams by improvement delta, not just current score. This surfaces where momentum is strongest, even if absolute maturity is still mid-range.
      </p>
      ...
      <div className="mt-6 h-[380px]">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={rows} layout="vertical" margin={{ top: 6, right: 12, left: 8, bottom: 6 }}>
            ...
            <Bar dataKey="current" name="Current" fill="#0f766e" radius={[0, 8, 8, 0]} />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </section>
